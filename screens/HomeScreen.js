...
export default class Homepage extends Component {
  ...
  togglegImage(){ this.setState(state => ({ glight: !state.glight })); }
  togglewImage(){ this.setState(state => ({ wlight: !state.wlight })); }
  toggleb1Image(){ this.setState(state => ({ b1light: !state.b1light })); }
  toggleb2Image(){ this.setState(state => ({ b2light: !state.b2light })); }
  togglelivImage(){this.setState(state => ({ livlight: !state.livlight })); }
  togglebathImage(){ this.setState(state => ({  bath1light: !state.bath1light })); }
  togglemasterImage(){ this.setState(state => ({ masterbedlight: !state.masterbedlight })); }
  togglekImage(){ this.setState(state => ({ klight: !state.klight })); }
  toggleMbathImage(){ this.setState(state => ({ Mbathlight: !state.Mbathlight })); }
  toggleDImage(){ this.setState(state => ({ Dlight: !state.Dlight })); }
  toggleFDoorImage(){ this.setState(state => ({ FDoor: !state.FDoor })); }
  toggleODoorImage(){ this.setState(state => ({ ODoor: !state.ODoor })); }
  toggleGDoorImage(){ this.setState(state => ({ GDoor: !state.GDoor })); }
  toggleBed1LampImage(){ this.setState(state => ({ Bed1Lamp: !state.Bed1Lamp })); }
  toggleBed1Lamp1Image(){ this.setState(state => ({ Bed1Lamp1: !state.Bed1Lamp1 })); }
  toggleBed2LampImage(){ this.setState(state => ({ Bed2Lamp: !state.Bed2Lamp })); }
  toggleBed2Lamp1Image(){ this.setState(state => ({ Bed2Lamp1: !state.Bed2Lamp1 })); }
  toggleMasterBedLampImage(){ this.setState(state => ({ MasterBedLamp: !state.MasterBedLamp })); }
  toggleMasterBedLamp1Image(){ this.setState(state => ({ MasterBedLamp1: !state.MasterBedLamp1 })); }
  toggleLivingLampImage(){ this.setState(state => ({ LivingLamp: !state.LivingLamp })); }
  toggleLivingLamp1Image(){ this.setState(state => ({ LivingLamp1: !state.LivingLamp1 })); }
  toggleMasterTVImage(){ this.setState(state => ({ MasterTV: !state.MasterTV })); }
  toggleLivingTVImage(){ this.setState(state => ({ LivingTV: !state.LivingTV })); }
  toggleMBathVImage(){ this.setState(state => ({ MBathV: !state.MBathV })); }
  toggleBathVImage(){ this.setState(state => ({ BathV: !state.BathV })); }
  toggledryerImage(){ this.setState(state => ({ dryer: !state.dryer })); }
  toggleWMImage(){ this.setState(state => ({ WM: !state.WM }));}
  togglestoveImage(){ this.setState(state => ({ stove: !state.stove }));}
  toggleovenImage(){ this.setState(state => ({ oven: !state.oven }));}
  toggleDWImage(){ this.setState(state => ({ DW: !state.DW }));}
  toggleMicroImage(){ this.setState(state => ({ Micro: !state.Micro }));}
  toggleACImage(){ this.setState(state => ({ AC: !state.AC }));}
  toggleheatImage(){ this.setState(state => ({ heat: !state.heat }));}
  togglefanImage(){ this.setState(state => ({ fan: !state.fan }));}
      ...
      <View style={styles.container}>
        <View style={styles.FloorPlanStackRow}>
          <View style={styles.FloorPlanStack}>
            ...
            >
              <View style={styles.GarageDoorRow}>
                <Image
                  source={this.state.GDoor ? open : closed}
                ...
                <View style={styles.Lights}>
                  <Image
                    source={this.state.glight ? on : off}
                  ...
                  <View style={styles.WashroomLightRow}>
                    <Image
                      source={this.state.wlight ? on : off}
                    ...
                    />
                    <Image
                      source={this.state.klight ? on : off}
                  ...
                  <Image
                    source={this.state.Mbathlight ? on : off}
                  ...
                  />
                  <Image
                    source={this.state.Dlight ? on : off}
                  ...
                  />
                  <Image
                    source={this.state.masterbedlight ? on : off}
                  ...
                  />
                  <Image
                    source={this.state.livlight ? on : off}
                  ...
                  />
                  <Image
                    source={this.state.b1light ? on : off}
                  ...
                  />
                  <Image
                    source={this.state.bath1light ? on : off}
                  ...
                  />
                  <Image
                    source={this.state.b2light ? on : off}
              ...
              <View style={styles.OutsideDoorRow}>
                <Image
                  source={this.state.ODoor ? open : closed}
                ...
                />
                <Image
                  source={this.state.dryer ? dryer_on : dryer_off}
                ...
                />
                <Image
                  source={this.state.WM ? WM_on : WM_off}
                ...
                />
                <Image
                  source={this.state.oven ? oven_on : oven_off}
                ...
                />
                <Image
                  source={this.state.stove ? stove_on : stove_off}
                ...
                />
                <Image
                  source={this.state.Micro ? Micro_on : Micro_off}
                ...
                />
                <Image
                  source={this.state.DW? DW_on : DW_off}
              ...
              <Image
                source={this.state.MBathV ? Vent_on : Vent_off}
              ...
              <View style={styles.MasterBedLampRow}>
                <Image
                  source={this.state.MasterBedLamp ? lamp_on : lamp_off}
                ...
                />
                <Image
                  source={this.state.MasterTV ? TV_on : TV_off}
                ...
                />
                <Image
                  source={this.state.MasterBedLamp1 ? lamp_on : lamp_off}
                ...
                />
                <Image
                  source={this.state.FDoor ? open : closed}
              ...
              <View style={styles.Bed1LampRow}>
                ...
                />
                <Image
                  source={this.state.LivingLamp ? lamp_on : lamp_off}
                ...
                />
                <Image
                  source={this.state.LivingTV ? TV_on : TV_off}
              ...
              <Image
                source={this.state.BathV ? Vent_on : Vent_off}
              ...
              <View style={styles.Bed2LampRow}>
                <Image
                  source={this.state.Bed2Lamp ? lamp_on : lamp_off}
                ...
                />
                <Image
                  source={this.state.Bed2Lamp1 ? lamp_on : lamp_off}
              ...
              <Image
                source={this.state.LivingLamp1 ? lamp_on : lamp_off}
          ...
          <View style={styles.ellipse2Stack}>
            ...
            <Image
              source={this.state.AC ? AC_on : AC_off}
            ...
            />
            <Image
              source={this.state.heat ? heat_on : heat_off}
            ...
            />
            <Image
              source={this.state.fan ? fan_on : fan_off}
